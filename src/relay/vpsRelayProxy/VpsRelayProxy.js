...
import { registerMasterDataRoutes } from "./masterData.js";
...
// Register master data routes (requires MASTER_DB_PATH)
if (process.env.MASTER_DB_PATH) {
  registerMasterDataRoutes(app, {
    dbPath: process.env.MASTER_DB_PATH,
    requireBoatSignature,
  });
}
